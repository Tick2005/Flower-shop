...
$search_condition = $search_query ? "WHERE name LIKE ?" : "";
        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="search-bar">
                <form action="" method="POST" class="relative">
                    <input type="text" name="search" placeholder="Search flowers..." value="<?php echo htmlspecialchars($search_query); ?>" class="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:border-green-500 text-gray-700">
    ...
    <main>
        ...
        <section class="py-12 bg-gray-100">
            <div class="container mx-auto px-4">
                ...
                <!-- View More Button -->
                <a href="/products" class="view-more-btn block text-center mt-8 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">Xem thêm bó hoa</a>
            </div>
        </section>
    </main>
