...
<body>
        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="nav-links flex space-x-6 items-center">
                ...
                <a href="cart.php" class="text-gray-700 hover:text-green-500 relative">
                    ...
                    <span class="absolute -top-2 -right-2 bg-green-500 text-white text-xs rounded-full px-2"><?php echo $cart_count_header; ?></span>
                </a>
    ...
    <p class="text-lg font-bold mb-4">Total: <?php echo number_format($total_price, 2, ',', '.'); ?>đ</p>

    <h3 class="text-lg font-bold mb-4">Shipping Information</h3>
    <!-- Phần form giữ nguyên như mã trước -->
